        ...
        <nav className="bg-white w-full z-20 top-0 start-0 border-b border-gray-200 dark:bg-darkgrey dark:border-gray-800">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <div className="flex items-center rtl:space-x-reverse">
                    ...
                    <span className="self-center text-2xl font-bold whitespace-nowrap dark:text-white">CompareDocs</span>
                </div>
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul className="flex flex-col gap-2 p-4 md:p-0 mt-4 font-normal border border-gray-100 rounded-lg bg-gray-50 dark:bg-darkgrey md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
                    <li>
